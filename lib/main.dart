...
import 'package:tochegando_motoboy/app/register_cubits.dart';
...
import 'package:tochegando_motoboy/presentation/cubits/localizations_cubit.dart';
import 'package:tochegando_motoboy/presentation/cubits/location/ringtone_cubit.dart';
import 'package:tochegando_motoboy/presentation/screens/Splash/initial_screen.dart';
              ...
              builder: (context, state) {
                if (state is LanguageLoader) {
                  final String languageCode =
                      (state.language is String && (state.language as String).isNotEmpty)
                          ? state.language as String
                          : 'pt';
...
''';
  ...
  final androidDetails = AndroidNotificationDetails(
    'ride_channel',
    'Ride Request',
    channelDescription: 'To Chegando Delivery Driver ride notifications',
